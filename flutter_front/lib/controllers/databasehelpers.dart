...
class DataBaseHelper {
  String serverUrl = "http://192.168.0.218:8000/api/login";
  String serverUrlproducts = "http://192.168.0.218:8000/api/products";
...
//function for register products
  void addDataProducto(String _nameController, String _priceController,
    ...
    String myUrl = "http://192.168.0.218:8000/api/products";
  ...
  void editarData(String id, String name, String price, String stock) async {
    ...
    String myUrl = "http://192.168.0.218:8000/api/products/$id";
